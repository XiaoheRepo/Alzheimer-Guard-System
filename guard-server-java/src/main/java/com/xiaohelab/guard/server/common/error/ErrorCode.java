...
public enum ErrorCode {
    ...
    E_GOV_4131(HttpStatus.PAYLOAD_TOO_LARGE, "E_GOV_4131", "上传文件体积超出允许上限"),
    ...
    E_CLUE_4011(HttpStatus.UNAUTHORIZED, "E_CLUE_4011", "entry_token 缺失或过期"),
    E_CLUE_4291(HttpStatus.TOO_MANY_REQUESTS, "E_CLUE_4291", "公开域访问频率超限"),
    ...
    E_AI_4030(HttpStatus.FORBIDDEN, "E_AI_4030", "非会话所有者,禁止访问或操作"),
