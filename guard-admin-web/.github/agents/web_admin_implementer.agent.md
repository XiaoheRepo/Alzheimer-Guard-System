...
| 优先级 | 文档     | 路径                             | 作用                                                      |
| ------ | -------- | -------------------------------- | --------------------------------------------------------- |
| 1      | **SRS**  | `doc/SRS.md`                     | 业务需求基线——决定"有没有这个页面/功能"                   |
| 2      | **SADD** | `doc/SADD_V2.0.md`               | 架构基线——分层、鉴权、链路追踪、WebSocket 规范            |
| 3      | **LLD**  | `doc/LLD_V2.0.md`                | 详细设计基线——状态机、字段枚举、交互流                    |
| 4      | **DBD**  | `doc/DBD.md`                     | 数据结构基线——字段类型、枚举值、展示格式                  |
| 5      | **API**  | `doc/API_V2.0.md`                | **联调契约基线**——URL / Method / Header / Body / Response |
| 6      | **BDD**  | `doc/backend_handbook_v2.md`     | 后端落地基线——错误码、事件名、限流/幂等/trace             |
| 7      | **WAHB** | `doc/web_admin_handbook_V2.0.md` | **实现规格基线**——页面清单、线框、交互、HC 集             |
